...
#endif
                VL_FATAL_MT("/home/wyh/ysyx-workbench/npc/vsrc/top.v", 1, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->__pinNumber8 = VL_RAND_RESET_I(1);
    ...
    vlSelf->top__DOT__controller__DOT__w_ptr = VL_RAND_RESET_I(3);
    vlSelf->top__DOT__controller__DOT__r_ptr = VL_RAND_RESET_I(3);
    vlSelf->top__DOT__controller__DOT__count = VL_RAND_RESET_I(4);
    vlSelf->top__DOT__controller__DOT__ps2_clk_sync = VL_RAND_RESET_I(3);
    vlSelf->top__DOT__controller__DOT____Vlvbound_h1a91ade8__0 = VL_RAND_RESET_I(1);
